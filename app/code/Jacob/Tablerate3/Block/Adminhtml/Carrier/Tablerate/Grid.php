 ...
 */
namespace Jacob\Tablerate3\Block\Adminhtml\Carrier\Tablerate;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Jacob\Tablerate3\Model\ResourceModel\Carrier\Tablerate\CollectionFactory $collectionFactory,
        \Jacob\Tablerate3\Model\Carrier\Tablerate $tablerate,
        array $data = []
    ) {
    ...
    {
        parent::_construct();
        $this->setId('shippingTablerate3Grid');
