...
namespace Jacob\Checkout\Controller\Index;
...
class Index extends \Magento\Checkout\Controller\Index\Index
{
    ...
    /**
     * @var \Jacob\Checkout\Helper\Data
     */
    protected $snusmeHelper;
    ...
    public function __construct(
        ...
        \Jacob\Checkout\Helper\Data $snusmeHelper
    ) {
        parent::__construct(
        ...
        $this->snusmeHelper = $snusmeHelper;
    ...
    public function execute()
    {
        ...
        $checkoutBlock
            ->setTemplate('Jacob_Checkout::onepage.phtml')
            ->setData('amcheckout_helper', $this->onepageHelper)
            ->setData('country_info', $this->snusmeHelper->getCountryInfoStructure())
        ;
