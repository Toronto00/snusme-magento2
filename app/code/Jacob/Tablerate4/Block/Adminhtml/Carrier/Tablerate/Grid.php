 ...
 */
namespace Jacob\Tablerate4\Block\Adminhtml\Carrier\Tablerate;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Jacob\Tablerate4\Model\ResourceModel\Carrier\Tablerate\CollectionFactory $collectionFactory,
        \Jacob\Tablerate4\Model\Carrier\Tablerate $tablerate,
        array $data = []
    ) {
    ...
    {
        parent::_construct();
        $this->setId('shippingTablerate4Grid');
