 ...
 */
namespace Jacob\Tablerate5\Model\ResourceModel\Carrier;

use Magento\Framework\Filesystem;
use Magento\Framework\Filesystem\DirectoryList;
use Jacob\Tablerate5\Model\ResourceModel\Carrier\Tablerate\Import;
use Jacob\Tablerate5\Model\ResourceModel\Carrier\Tablerate\RateQuery;
use Jacob\Tablerate5\Model\ResourceModel\Carrier\Tablerate\RateQueryFactory;
...
class Tablerate extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('shipping_tablerate5', 'pk');
    }
    ...
    public function uploadAndImport(\Magento\Framework\DataObject $object)
    {
         ...
         */
        if (empty($_FILES['groups']['tmp_name']['tablerate5']['fields']['import']['value'])) {
            return $this;
        }
        $filePath = $_FILES['groups']['tmp_name']['tablerate5']['fields']['import']['value'];
    ...
    {
        if ($object->getData('groups/tablerate5/fields/condition_name/inherit') == '1') {
            $conditionName = (string)$this->coreConfig->getValue('carriers/tablerate5/condition_name', 'default');
        } else {
            $conditionName = $object->getData('groups/tablerate5/fields/condition_name/value');
        }
