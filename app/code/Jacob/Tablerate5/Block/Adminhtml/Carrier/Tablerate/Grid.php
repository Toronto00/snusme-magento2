 ...
 */
namespace Jacob\Tablerate5\Block\Adminhtml\Carrier\Tablerate;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Jacob\Tablerate5\Model\ResourceModel\Carrier\Tablerate\CollectionFactory $collectionFactory,
        \Jacob\Tablerate5\Model\Carrier\Tablerate $tablerate,
        array $data = []
    ) {
    ...
    {
        parent::_construct();
        $this->setId('shippingTablerate5Grid');
