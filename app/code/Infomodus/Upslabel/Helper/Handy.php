...
class Handy extends AbstractHelper
{
    ...
    public function intermediate($order, $type, $shipmentId = null)
    {
        ...
        $shippingInternational = $this->shippingAddress->getCountryId() == $this->_conf->getStoreConfig('upslabel/address_' . $this->_conf->getStoreConfig('upslabel/shipping/defaultshipfrom', $this->storeId) . '/countrycode', $this->storeId) ? 0 : 1;
